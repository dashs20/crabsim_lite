...
gnc_log_array = np.zeros((n_steps,7))
gnc_log_col_names = ["fpx_frac","fnx_frac","phi_px_rad","phi_nx_rad",
...
for i_step in range(n_steps):
    ...
    gnc_log_array[i_step,:] = crabbrain.step(w_des_radps,crabcopter.body.W_B_wrt_I_radps,thr_frac)
    act_cmd = gnc_log_array[i_step,0:4]
